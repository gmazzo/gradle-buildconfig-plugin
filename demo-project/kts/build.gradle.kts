...
buildConfig {
    ...
    buildConfigField("BYTE_NATIVE_ARRAY_NULLABLE", byteArrayOf(1, 2, 3) as ByteArray?)
    buildConfigField("BYTE_NATIVE_ARRAY_NULL", null as ByteArray?)
    ...
    buildConfigField("BYTE_ARRAY_NULL", null as Array<Byte?>?)
    ...
    buildConfigField("SHORT_NATIVE_ARRAY_NULLABLE", shortArrayOf(1, 2, 3) as ShortArray?)
    buildConfigField("SHORT_NATIVE_ARRAY_NULL", null as ShortArray?)
    ...
    buildConfigField("SHORT_ARRAY_NULL", null as Array<Short?>?)
    ...
    buildConfigField("CHAR_NATIVE_ARRAY_NULLABLE", charArrayOf('a', 'b', 'c') as CharArray?)
    buildConfigField("CHAR_NATIVE_ARRAY_NULL", null as CharArray?)
    ...
    buildConfigField("CHAR_ARRAY_NULL", null as Array<Char?>?)
    ...
    buildConfigField("INT_NATIVE_ARRAY_NULLABLE", intArrayOf(1, 2, 3) as IntArray?)
    buildConfigField("INT_NATIVE_ARRAY_NULL", null as IntArray?)
    ...
    buildConfigField("INT_ARRAY_NULL", null as Array<Int?>?)
    ...
    buildConfigField("LONG_NATIVE_ARRAY_NULLABLE", longArrayOf(1L, 2L, 3L) as LongArray?)
    buildConfigField("LONG_NATIVE_ARRAY_NULL", null as LongArray?)
    ...
    buildConfigField("LONG_ARRAY_NULL", null as Array<Long?>?)
    ...
    buildConfigField("FLOAT_NATIVE_ARRAY_NULLABLE", floatArrayOf(1f, 2f, 3f) as FloatArray?)
    buildConfigField("FLOAT_NATIVE_ARRAY_NULL", null as FloatArray?)
    ...
    buildConfigField("FLOAT_ARRAY_NULL", null as Array<Float?>?)
    ...
    buildConfigField("DOUBLE_NATIVE_ARRAY_NULLABLE", doubleArrayOf(1.0, 2.0, 3.0) as DoubleArray?)
    buildConfigField("DOUBLE_NATIVE_ARRAY_NULL", null as DoubleArray?)
    ...
    buildConfigField("DOUBLE_ARRAY_NULL", null as Array<Double?>?)
    ...
    buildConfigField("BOOLEAN_NATIVE_ARRAY_NULLABLE", booleanArrayOf(true, false, false) as BooleanArray?)
    buildConfigField("BOOLEAN_NATIVE_ARRAY_NULL", null as BooleanArray?)
    ...
    buildConfigField("BOOLEAN_ARRAY_NULL", null as Array<Boolean?>?)
