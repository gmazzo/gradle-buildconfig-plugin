...
buildConfig {
    ...
    buildConfigField("MAGIC_NUMBERS22", intArrayOf(1, 2, 3, 4))
    buildConfigField("Integer[]", "MAGIC_NUMBERS3", "intArrayOf(1, 2, 3, 4)")
    buildConfigField("MAGIC_NUMBERS4", arrayOf(1, 2, 3, 4))
    ...
    buildConfigField(type("com.github.gmazzo.buildconfig.demos.kts.SomeData"), "MY_DATA2", expression("SomeData(\"a\",1)"))
